    ...
    return (
        <div className="text-center mb-16">
            <motion.span
                ...
                viewport={{ once: true }}
                className="inline-block px-6 py-2 mb-4 text-sm font-semibold text-purple-400 bg-purple-500/10 border border-purple-500/30 rounded-full shadow-lg"
            >
                {badge}
            </motion.span>
            <motion.h2
                ...
                className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight font-outfit"
            >
                Learn From <span className="bg-gradient-to-r from-pink-400 via-purple-400 to-rose-400 bg-clip-text text-transparent">Industry Leaders</span>
            </motion.h2>
            <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
