...
// import { ArrowRight, Play, Users, BookOpen, Award, Code2, Cloud, Database, Cpu, Layers, Zap, ChevronRight } from "lucide-react";
// import { motion, AnimatePresence } from "framer-motion";

// // --- Sub-components provided by user ---
...
//         const init = () => {
//             particles = [];
//             const numberOfParticles = Math.min(((canvas?.width || 1000) * (canvas?.height || 1000)) / 15000, 100);
...
//                 >
//                     <div
//                         className={`p-3 rounded-2xl bg-gradient-to-br ${color} shadow-2xl backdrop-blur-sm`}
//                     >
...
//             <motion.p
//                 className="mt-6 text-lg md:text-xl text-gray-300 max-w-xl leading-relaxed font-outfit"
...
//                                 <span className="text-white/70 text-sm font-medium">Empowering Next-Gen Tech Talent</span>
//                             </div>

//                             <AnimatedHeadline
//                                 text="Accelerate Your Tech Career With Expert Guidance"
...
//                                 <Link href="/courses">
//                                     <Button className="w-60 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-4xl px-8 h-15 text-base font-semibold shadow-xl shadow-purple-500/20 transition-all group border-0">
//                                         Explore Courses
...
//                                 <Button
//                                     variant="outline"
//                                     className="w-60 border-white/10 text-white hover:bg-white/5 rounded-4xl px-8 h-15 text-base font-semibold backdrop-blur-md bg-white/5"
//                                 >
...
//                                 <div
//                                     className="w-full h-full bg-cover bg-center opacity-70 group-hover:scale-105 transition-transform duration-700"
